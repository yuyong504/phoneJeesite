...
<head>
	...
	<%@include file="/WEB-INF/views/modules/cms/front/include/xyfs_head.jsp" %>
...
<body>
	...
	<div class="container">
		...
		${site.copyright} 
		${fns:getDate('yyyy年MM月dd日 E')}
		<!-- # Footer Ends -->
		<div class="footer_nav"><a href="${ctx}/guestbook" target="_blank">公共留言</a> | <a href="${ctx}/search" target="_blank">全站搜索</a> | <a href="${ctx}/map-${site.id}${fns:getUrlSuffix()}" target="_blank">站点地图</a> | <a href="mailto:504332924@qq.com">技术支持</a> | <a href="${pageContext.request.contextPath}${fns:getAdminPath()}" target="_blank">后台管理</a></div>
      	</div>
      	</footer>
    </div> <!-- /container -->
</body>
